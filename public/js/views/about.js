  ...
  render(root, app) {
    ...
    <div class="grid" style="grid-template-columns:1.6fr 1fr;gap:16px">
      <div class="card"><div class="card-b" style="padding:24px 26px">
        ...
        ${S('🎯', L('消遣：87 项花钱买松弛的事', 'Things to do: 87 ways to spend your way calm'), `<p>${L(
          '压力不是只能靠睡觉。<b>87 项活动</b>分成十类——体育运动、看点什么、文化艺术、social、户外自然、居家、学点东西、刺激、照顾自己、碰运气。从 <b>$0 的夜跑</b>、<b>$0 的睡到自然醒</b>，到 <b>$22 看场电影</b>、<b>$70 按摩</b>、<b>$420 跳伞</b>、<b>$1,400 静修营</b>、<b>$6,500 的高管研修班</b>。<br>每一项都<b>实打实占掉游戏时间</b>，这段时间上不了班——松弛是有代价的。除了降压力，有的加体力（睡到自然醒 +14），有的涨经验（编程训练营 +14），有的涨声望（慈善晚宴 +38）。<br>而且<b>会腻</b>：同一件事连着做，效果掉到 55%，隔一阵才回满。连看三场电影，第三场就不是那么有意思了。',
          'Sleep is not the only way down. <b>Eighty-seven activities</b> in ten categories — sport, screens, culture, going out, outdoors, at home, learning, thrills, self-care and chancing it. From a <b>free evening run</b> or <b>sleeping in</b>, through <b>$22 for a film</b>, <b>$70 for a massage</b>, <b>$420 to jump out of a plane</b>, <b>$1,400 for a silent retreat</b>, up to a <b>$6,500 executive programme</b>.<br>Every one of them <b>genuinely consumes in-game hours</b> during which you cannot work — relaxing costs something. Besides stress they move other things: sleeping in restores 14 stamina, a coding bootcamp is worth 14 experience, a charity gala is worth 38 standing.<br>And <b>it gets stale</b>: repeat the same thing and it drops to 55% effect until enough time passes. The third film in a row is not the film the first one was.')}</p>`)}

        ${S('🏢', L('总部：把管理这件事本身外包出去', 'A head office: outsourcing management itself'), `<p>${L(
          '店长解决的是一家店，不是一个人的时间。<b>43 家店每家 0.15 小时，还是 6.5 个小时</b>——一天就没了，再开十家你连班都上不了。现实里没有人这么撑着：到了一定规模就该搭管理层。<br>四级<b>总部</b>，每一级覆盖一定数量的店，<b>被覆盖的店管理时间归 0</b>，连出门巡店都不用了；覆盖不到的还得你自己盯：<br>🧑‍💼 <b>区域经理</b> 8 家 · 👔 <b>运营总监</b> 25 家 · 🏢 <b>总部管理团队</b> 80 家 · 🏛️ <b>集团总部</b> 不限店数。<br>工资不是一个死数，它<b>跟着这个总部实际管的摊子走</b>：现实里区域经理拿的就是店长的一点几倍，往上每一层按同样的比例叠——管 25 家便利店和管 25 家酒店，不该是一个价。所以每一级给的是相对店长工资合计的倍数（0.55 / 0.80 / 1.10 / 1.50）和一个起薪。<br>钱从谁的账上出，看店归谁：<b>公司的店走公司账，个人名下的店走你自己的现金</b>。个人实业和每一家公司各有各的总部，在实业页各自那一组里设。<br>这是这个游戏里最典型的一笔钱：<b>你花钱买回来的不是收入，是你自己的时间</b>。买回来之后拿它去做什么，才决定这笔钱值不值。',
          'A store manager solves a shop, not a person\'s day. <b>Forty-three shops at 0.15 hours each is still 6.5 hours</b> — the day is gone, and ten more shops and you cannot hold a job at all. Nobody in the real world carries that: past a certain size you build a management layer.<br>Four tiers of <b>head office</b>, each covering a number of shops. <b>Shops it covers cost you no time at all</b> — not even the trip out to look at them. Shops it does not cover still want their hours:<br>🧑‍💼 <b>Area manager</b>, 8 · 👔 <b>Operations director</b>, 25 · 🏢 <b>Head office</b>, 80 · 🏛️ <b>Group head office</b>, no cap.<br>The payroll is not a fixed number: it <b>scales with what that head office actually runs</b>. A regional manager earns a multiple of a store manager\'s salary, and every layer above stacks on the same basis — overseeing 25 corner shops should not cost what overseeing 25 hotels costs. So each tier is a multiple of the covered shops\' store-manager payroll (0.55 / 0.80 / 1.10 / 1.50) with a floor under it.<br>Whoever owns the shops pays the bill: <b>a company\'s shops come off the company books, shops you hold personally come out of your own cash</b>. Your personal businesses and each company get their own head office, set from that group on the Businesses page.<br>This is the most characteristic purchase in the game: <b>what you are buying is not income, it is your own time</b>. What you do with it afterwards is what decides whether it was worth the money.')}</p>`)}

        ${S('📊', L('属性：知识、运气、魅力', 'Attributes: knowledge, luck and charm'), `<p>${L(
          '你在业余时间做的事，会慢慢把你变成另一个人。三条属性，都在「人物 → 属性」页上：<br><b>📚 知识</b>——学到的东西不会还回去，永不衰减。满级时工资 <b>+35%</b>、学东西快 <b>+80%</b>、名下每家店的营收 <b>+10%</b>。靠上网课、学语言、读商业书、扫街拍照、高管研修班养出来。<br><b>🍀 运气</b>——手气这种东西留不住，<b>每个游戏日回落 1.5 点</b>。它抬彩票的中奖率（最高 +50%），让你碰上的好事多、倒霉的事少（好事占比从 47% 提到 78%），也让你少生病。靠新开的<b>「碰运气」</b>这一类养：刮刮乐、抓娃娃机、拆盲盒、去庙里拜拜、算命、麻将局、赛马场、德州扑克、赌场一晚。<br><b>✨ 魅力</b>——靠维持，停下来就慢慢淡了（每日 −0.6）。融资时投资人少压你 <b>8 个点</b>，同一件事涨的声望多 <b>60%</b>，同一身衣服穿出来的分高 <b>50%</b>。靠理发、水疗、慈善晚宴、婚礼、心理咨询养。<br>三条都是<b>渐近线，不是进度条</b>：越往上，同一件事推得越少。前 50 点很好拿，80 往上要花真金白银——那些贵活动存在的意义就在这儿。<br>顺带一句：运气把彩票的回本率从 57% 抬到 85%，<b>但永远抬不过 100%</b>。运气能让你少输，不该让你靠买彩票发家。',
          'What you do with your evenings slowly turns you into someone else. Three attributes, all on Character → Attributes:<br><b>📚 Knowledge</b> — what you learn, you keep; it never decays. At the top it is worth <b>+35% on wages</b>, <b>+80% on how fast you learn</b>, and <b>+10% revenue at every shop you own</b>. Built from online courses, language classes, business reading, street photography and an executive programme.<br><b>🍀 Luck</b> — a run of luck does not keep: it <b>drains 1.5 points a game day</b>. It lifts lottery win rates (up to +50%), tilts what life throws at you toward the good (good outcomes go from 47% to 78%), and keeps you healthier. Built in the new <b>Chancing It</b> category: scratchcards, claw machines, blind boxes, praying for luck, a fortune teller, mahjong, the races, poker, a night at the casino.<br><b>✨ Charm</b> — kept up, or it fades (−0.6 a day). Investors mark you down <b>8 points less</b> at a funding round, the same deed earns <b>60% more standing</b>, and the same clothes score <b>50% higher</b>. Built from haircuts, spa days, charity galas, weddings and therapy.<br>All three are <b>asymptotes, not progress bars</b>: the higher you are, the less the same evening moves you. The first 50 points come easily; past 80 it takes real money — which is what the expensive activities are for.<br>One note: luck lifts a scratchcard from a 57% return to 85%, but <b>never past 100%</b>. Luck should let you lose less; it should not let you get rich buying tickets.')}</p>`)}
