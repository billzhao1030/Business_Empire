...
| **🏆 A rich list you can actually move** | 218 people covering all 200 listed companies — every stock has a real major shareholder — plus a company board ranking all 201 by market cap with yours in it. Two things genuinely move them: buying their stock (whatever you own stops counting as theirs; at 100% they are erased from that company), and building at scale in their sector, which drags the incumbents' **intrinsic value** down at 5.5% a year for every 10% of share you take. A running total shows how much market value you have taken off them. |
