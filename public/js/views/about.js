    ...
    <div class="grid" style="grid-template-columns:1.6fr 1fr;gap:16px">
      <div class="card"><div class="card-b" style="padding:24px 26px">
        ...
        ${S('🍚', L('生活开销：钱是怎么没的', 'Cost of living: where the money goes'), `<p>${L(
          '每天都要吃饭，每月都要交房租——这两笔钱从你赚到第一块钱的那天起就没停过。<b>伙食</b>有六档，从「饿着」($0) 到「私人厨师」($420/天)：吃得差会持续掉体力、涨压力，患病概率最高翻一倍；吃得好则相反。<b>住处</b>三档，合租单间 $340/月到高档公寓 $2,200/月；买了自己的房子就不用再交房租。<br>开局在发传单（$8/工时）时，路边摊伙食 + 合租房租 = <b>每月 $820，占月薪的 43%</b>。这就是为什么攒钱不容易。<br>如果连饭钱都拿不出来，你会自动变成「饿着」——身体撑不了几天。',
          'You eat every day and pay rent every month, and neither stops from the moment you earn your first dollar. <b>Meals</b> come in six tiers, from skipping them ($0) to a private chef ($420/day): eating badly drains stamina, adds stress and doubles your chance of falling ill; eating well does the reverse. <b>Housing</b> runs from a $340/month shared room to a $2,200 apartment — and once you own a home, the rent stops.<br>On a flyer-handout wage ($8/hour), street food plus a shared room comes to <b>$820 a month, 43% of your pay</b>. That is why saving is hard.<br>If you cannot cover food at all you are forced to skip meals, and your body will not take much of that.')}</p>`)}
