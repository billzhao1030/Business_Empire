...
export const CO_HINTS = {
  up: [
    ...
    ['{X} 把明年才到期的设备订单提前付了全款', '{X} paid in full, early, for equipment not due until next year'],
    ['{X} 的园区停车场周末满了，保安说这个月一直如此', '{X}’s car park is full at weekends, and the guard says it has been all month'],
    ['{X} 的产线这个月第一次排到了三班倒', '{X} put a line on three shifts this month for the first time'],
