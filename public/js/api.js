...
export const api = {
  ...
  company: () => req('/api/company'),
  coFound: (name, nameEn, ticker, sector, shopIds) => post('/api/company/found', { name, nameEn, ticker, sector, shopIds }),
  coShops: (add, remove) => post('/api/company/shops', { add, remove }),
  coRaise: () => post('/api/company/raise', {}),
  ...
  travel: (destId, nights, cabin, hotel) => post('/api/trip', { destId, nights, cabin, hotel }),
