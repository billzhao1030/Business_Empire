  ...
  render(root, app) {
    ...
    <div class="grid" style="grid-template-columns:1.6fr 1fr;gap:16px">
      <div class="card"><div class="card-b" style="padding:24px 26px">
        ...
        <p style="margin-top:8px">${L(
          '成本是按真实生意拆开的：<b>进货成本</b>按每个行业自己的毛利率算（酒吧 20%、超市 74%），<b>人工</b>约 22%（一名员工大约创造自身工资 4.5 倍的营收），<b>房租</b>按开办成本的比例逐月扣、关门也照付，净利率稳定在 26~30%。回本周期从小摊的 38 个游戏日到重资产的 330 天——不再是三天回本的童话。<br>大城市营收更高，但<b>房租涨得比营收更快</b>：同一家奶茶店，小镇 82 天回本，迪拜要 213 天。去大城市图的是单店能吃下更多资本，而不是更高的回报率。<br>而且<b>异地开店必须亲自飞过去</b>：往返机票 + 在当地待上几天，这期间你不能上班。',
          'Costs are broken out the way a real business is: <b>cost of goods</b> at each industry\'s own rate (20% at a bar, 74% at a supermarket), <b>wages</b> around 22% (one employee generates roughly 4.5× their own wage), and <b>rent</b> charged monthly against the fit-out cost whether the doors are open or not. Net margin settles at 26–30%, and payback runs from 38 in-game days for a stall to 330 for heavy industry — no more three-day miracles.<br>Bigger cities take more but <b>rent rises faster than revenue</b>: the same bubble tea shop pays back in 82 days in a small town and 213 in Dubai. You go to the big city to deploy more capital per shop, not for a better return.<br>And <b>opening in another city means flying there</b>: return airfare plus days on the ground, during which you cannot work.')}</p>
        <p style="margin-top:8px">${L(
