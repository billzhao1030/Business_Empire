...
1. 到**生涯**页点「**接一单加班**」——每单 = 干 **1 个工时**，按 **1.6 倍**加班费结算，
   每个游戏日最多加班 **6 小时**。六单下来（约 30 秒）就有 $173
2. **$120** 开一个「街头小摊」，它会替你 24 小时不停地赚钱
3. 攒到 **$900** 买一辆二手电动车 → 解锁「网约车司机」，时薪从 $18 跳到 $130
4. 用店铺利润滚出更多店铺，同时开始炒股、买商圈份额
5. 信用分够了就贷款加杠杆，买房吃租金
6. 终局：买满一家公司的限购比例，发起**全面收购要约**，把它变成全资子公司

**工时是有硬上限的**：正常班每个游戏日 **8:00–20:00**（12 小时）自动结算，
另外最多再加班 **6 小时**（1.6 倍工资）——一天就 24 小时，剩下的时间总得睡觉。
所以打工收入封顶在「日薪 = 时薪 × 21.6」，真正能无限放大的是生意。
