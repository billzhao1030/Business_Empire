...
富豪榜上有 **218 个人**，覆盖全部 200 家上市公司——每一支股票背后都有具体的大股东。
公司榜按市值排全部 **201 家**公司，你自己的也在里面（未上市的按估值折算）。

**这些人不是背景板。** 两条路能真的动到他们的钱：

**一、买他们公司的股份。** 你买走的部分不再算在原股东名下——持有 5%，他的股权价值就少 5%；
买到 **100%**，他就从这家公司里被整个抹掉，只剩场外资产。

**二、在同一个赛道上把生意做大。** 你的年营收按市销率折成等效市值，
和该板块所有上市公司的总市值相比，就是你的份额：
...
这是**基本面下压**，不是情绪波动，均值回归拉不回来。富豪榜上的「你对这个世界的影响」面板
一直记着**你累计从他们手里拿走了多少市值**；跨过 1%、5%、12%、25% 的门槛时，
市场快讯里会出现你的名字。
