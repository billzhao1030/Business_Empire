  ...
  render(root, app) {
    ...
    <div class="grid" style="grid-template-columns:1.6fr 1fr;gap:16px">
      <div class="card"><div class="card-b" style="padding:24px 26px">
        ...
        ${S('⭐', L('声望：越攒涨得越慢，但永远不会白攒', 'Standing: it saturates, but it is never wasted'), `<p>${L(
          '房产、座驾、腕表、艺术品，穿在身上的衣服，出去旅行，把公司带上市——这些都会累积<b>声望</b>，而声望会加在你所有店铺的营收上。<br>但它不是线性的。原来那套是「每点 +0.12%、到 60% 封顶」，两头都说不通：<b>买一艘游艇就让全部店铺营收涨六成</b>，那不是声望是魔法；而且 500 点之后就完全封死了——第 500 点值 0.12%，第 501 点值 0，攒再多也是白攒。<br>现在是一条<b>饱和曲线</b>：<code>30% × p/(p+500)</code>。永远在涨，涨得越来越慢，无限接近 30% 但永远到不了。500 点拿到一半（15%），1,000 点 20%，5,000 点 27%。<b>前期每一点声望都很值钱</b>，后期只是锦上添花——但再也没有「攒了也没用」的那一段。<br>30% 这个天花板是有道理的：名气确实能带来更好的铺位、更好的账期和免费的口碑，但它顶不上把店开在对的地方，更顶不上选对一个行业。',
          'Property, cars, watches, art, the clothes you actually wear, travel, taking a company public — all of it accumulates <b>standing</b>, which lifts revenue across every shop you own.<br>It used to be linear: +0.12% a point, capped at 60%. Both halves were wrong. <b>A yacht should not lift every shop\'s revenue by sixty percent</b> — that is not reputation, it is magic. And past 500 points it was sealed shut: the 500th point was worth 0.12%, the 501st was worth nothing at all.<br>It is now a <b>saturating curve</b>: <code>30% × p/(p+500)</code>. Always rising, always more slowly, approaching 30% without ever arriving. 500 points buys half of it (15%), 1,000 buys 20%, 5,000 buys 27%. <b>Early standing is worth a great deal</b> — the step from unknown to somewhat known is the valuable one — and later standing is a garnish, but there is no longer a range where accumulating it does nothing.<br>The 30% ceiling is deliberate: being known genuinely wins you better sites, better terms and free word of mouth. It does not beat picking the right location, and it certainly does not beat picking the right trade.')}</p>`)}
